...
public protocol DKImagePickerControllerDelegate: UINavigationControllerDelegate {
...
public class DKImagePickerController : UINavigationController {
    // Delegate Object
    public var dkPickerDelegate:DKImagePickerControllerDelegate?
	...
	internal func dismiss() {
        if let d = self.dkPickerDelegate {
            d.dkImagePickerController(self, didFinishPickingAssets: self.selectedAssets)
        } else {
...
//		self.didCancel?()
	...
	internal func unselectedImage(asset: DKAsset) {
        ...
        if let d = self.dkPickerDelegate {
            d.dkImagePickerControllerDidCancel(self)
