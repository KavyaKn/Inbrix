...
CGFloat const kRNGridMenuDefaultDuration = 0.0f;
...
- (instancetype)initWithItems:(NSArray *)items {
    if ((self = [super init])) {
        ...
        _itemTextColor = [UIColor orangeColor];
...
- (void)layoutAsList {
    ...
    CGFloat height = self.itemSize.width * self.items.count;
...
- (void)layoutAsGrid {
    ...
    NSInteger rowCount = ceilf(sqrtf(itemCount/2));
