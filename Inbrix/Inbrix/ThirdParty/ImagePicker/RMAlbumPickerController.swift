...
class RMAlbumPickerController: UITableViewController, RMAssetSelectionDelegate, UIAlertViewDelegate, PHPhotoLibraryChangeObserver {
    ...
    override func viewDidLoad() {
        ...
        let cancelButton = UIBarButtonItem(
            ...
            target: self,
            action: #selector(RMAlbumPickerController.cancelImagePicker))
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        for (idx, poster) in cell.posterImgs.enumerate() {
    ...
    func photoLibraryDidChange(changeInstance: PHChange) {
        ...
        dispatch_async(dispatch_get_main_queue(), { () -> Void in
            ...
            for (idx, fetchResult) in self.allCollections.enumerate() {
